    ...
    */
    var detectImage = function (event) {
        if (event.target.nodeName !== 'DIV') {
            ...
            var originalImageSrc = imageSrc.replace('placeholders/' + imageName, imageNameOnly);
    ...
    var openOverlay = function (sourceImg, idImg) {
        ...
        if (imagesData[idImg] === undefined) {
            ...
            document.querySelector(DOM.overlayDimensions).innerHTML = imagesData[idImg].dimensions;
            document.querySelector(DOM.overlayFormat).innerHTML = imagesData[idImg].format;
            document.querySelector(DOM.overlayTags).innerHTML = imagesData[idImg].tags;
